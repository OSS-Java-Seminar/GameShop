...
public class HomeController {
	...
	@RequestMapping("/browseGames")
	public String browseGames(Model model, Principal principal) {
		if (principal != null) {
	...
	public String gameDetails(@PathParam("id") Long id, Model model, Principal principal) {
		if (principal != null) {
			String username = principal.getName();
			User user = userService.findByUsername(username);
			model.addAttribute("user", user);
